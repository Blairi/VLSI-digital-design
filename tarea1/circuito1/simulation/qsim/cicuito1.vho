...
-- Design Ports Information
-- pin_name2	=>  Location: PIN_L18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_M8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- pin_name1	=>  Location: PIN_L19,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF cicuito1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst6~0_combout\ = (((\inst1~q\) # (!\inst8~q\)) # (!\inst7~q\)) # (!\inst9~q\)
...
-- Equation(s):
-- \inst6~combout\ = (\inst6~0_combout\) # (\pin_name1~input_o\)
...
\inst8~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
